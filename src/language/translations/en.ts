export default {
  welcome: 'Welcome to your portal for Recalls Canada. Would you like to hear about recent recalls? Or search for a specific recall by saying "Search for" and the item you are looking for, or by category by saying Medical, Vehicle, Consumer Products or Food.',
  ...
  fallBack: 'Recall Canada test cannot help you with that. It can tell you about current Canadian Recalls.',
  cannotUnderstand: 'Sorry, I cannot understand the command. Please say again.',
  smthWrong: 'Something went wrong',
  mostRecent: 'These are the most recent recalls.',
  ...
  foodLatest: 'Here is the latest Food recall.',
