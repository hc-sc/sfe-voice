...
This is the jovo prototype branch for the canada recalls voice assistant, based off the Jovo hello world sample app - readme preserved below.

In addition to the jovo app, there is a botsociety module used to extract the conversation data from the Botsociety API service.
